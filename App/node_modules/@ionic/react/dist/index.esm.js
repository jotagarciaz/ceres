...
const createOverlayComponent = (displayName, controller) => {
    ...
    return class extends React.Component {
        ...
        async present(prevProps) {
            const _a = this.props, { children, isOpen, onDidDismiss = () => { return; } } = _a, cProps = __rest(_a, ["children", "isOpen", "onDidDismiss"]);
...
const IonPage = /*@__PURE__*/ (() => class IonPageInternal extends React.Component {
    constructor() {
        super(...arguments);
    ...
    render() {
        const _a = this.props, { className, children } = _a, props = __rest(_a, ["className", "children"]);
