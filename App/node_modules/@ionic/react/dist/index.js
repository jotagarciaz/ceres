...
const createControllerComponent = (displayName, controller) => {
    ...
    return class extends React__default.Component {
        constructor(props) {
            super(props);
...
const createOverlayComponent = (displayName, controller) => {
    ...
    return class extends React__default.Component {
        ...
        async present(prevProps) {
            const _a = this.props, { children, isOpen, onDidDismiss = () => { return; } } = _a, cProps = tslib_1.__rest(_a, ["children", "isOpen", "onDidDismiss"]);
            const elementProps = Object.assign({}, cProps, { [dismissEventName]: onDidDismiss });
            const overlay = this.overlay = await controller.create(Object.assign({}, elementProps, { component: this.el, componentProps: {} }));
...
const IonPage = /*@__PURE__*/ (() => class IonPageInternal extends React__default.Component {
    constructor() {
        super(...arguments);
    ...
    render() {
        const _a = this.props, { className, children } = _a, props = tslib_1.__rest(_a, ["className", "children"]);
